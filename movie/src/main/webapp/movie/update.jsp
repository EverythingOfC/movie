...
<form action="ms?command=update" method="post" enctype="multipart/form-data">
	...
	<table>
		...
		<tr>
		<th>포스터</th>
		<td><div style="padding-bottom:10px; font-size:12px;">변경 전 <img src="upload/${movie.poster}" style="width:300px; height:120px;"></div>
			<div style="font-size:12px;" >변경 후 <input type="file" name="poster" onchange="readURL(this);" style="padding:0; text-align:center;">
				  <img style="width:300px; height:150px; " id="preview"/></div>
		</td>
		</tr>
